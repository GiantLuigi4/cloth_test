...
public class Point extends AbstractPoint {
	...
	public Point(Vector3 pos, Vector3[] refs, Vector3[] hypotRefs) {
		this(pos, refs, hypotRefs, defaultConstraint);
	}
	
	public Point(Vector3 pos, Vector3[] refs, Vector3[] hypotRefs, Constraint constraint) {
		this.pos = pos;
		this.refs = refs;
		this.hypotRefs = hypotRefs;
		chainSize0 = 1;
